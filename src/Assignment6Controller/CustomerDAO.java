...
public class CustomerDAO implements DAOInterface<BankCustomer> {
    ...
    // Method to retrieve a user from the database by city
    public BankCustomer getCustomersByCity(String city) throws SQLException {
        
        pStatement = connection.prepareStatement(CustomerDataConnection.getSelectCity());
